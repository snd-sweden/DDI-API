...
using DDIClassLibrary.v3_1.archive;
using DDIClassLibrary.v3_1.conceptualcomponent;
using DDIClassLibrary.v3_1.datacollection;
using DDIClassLibrary.v3_1.ddiprofile;
using DDIClassLibrary.v3_1.logicalproduct;
using DDIClassLibrary.v3_1.physicaldataproduct;
using DDIClassLibrary.v3_1.physicalinstance;
using DDIClassLibrary.v3_1.reusable;

namespace DDIClassLibrary.v3_1.studyunit
{
    [System.Serializable()]
