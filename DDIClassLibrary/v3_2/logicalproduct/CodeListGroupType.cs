...
namespace DDIClassLibrary.v3_2.logicalproduct
{
    ...
    public class CodeListGroupType : VersionableType, IHaveDefaultValues
    {
        public CodeListGroupType()
        {
            this.CodeListGroupName = new List<NameType>();
        ...
        public CodeValueType TypeOfCodeListGroup { get; set; }

        [System.Xml.Serialization.XmlElement(IsNullable = true, Order = 1)]
        public List<NameType> CodeListGroupName { get; set; }
