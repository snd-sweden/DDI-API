...
namespace DDIClassLibrary.v3_2.datacollection
{
    ...
    public class InstructionGroupType : VersionableType, IHaveDefaultValues
    {
        public InstructionGroupType()
        {
            this.InstructionGroupName = new List<NameType>();
        ...
        public CodeValueType TypeOfInstructionGroup { get; set; }

        [System.Xml.Serialization.XmlElement(IsNullable = true, Order = 1)]
        public List<NameType> InstructionGroupName { get; set; }
