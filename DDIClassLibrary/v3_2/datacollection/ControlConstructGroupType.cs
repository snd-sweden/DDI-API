...
namespace DDIClassLibrary.v3_2.datacollection
{
    ...
    public class ControlConstructGroupType : VersionableType, IHaveDefaultValues
    {
        public ControlConstructGroupType()
        {
            this.ControlConstructGroupName = new List<NameType>();
        ...
        public CodeValueType TypeOfControlConstructGroup { get; set; }

        [System.Xml.Serialization.XmlElement(IsNullable = true, Order = 1)]
        public List<NameType> ControlConstructGroupName { get; set; }
