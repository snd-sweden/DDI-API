...
namespace DDIClassLibrary.v3_2.datacollection
{
    ...
    public class ProcessingEventGroupType : VersionableType, IHaveDefaultValues
    {
        public ProcessingEventGroupType()
        {
            this.ProcessingEventGroupName = new List<NameType>();
        ...
        public CodeValueType TypeOfProcessingEventGroup { get; set; }

        [System.Xml.Serialization.XmlElement(IsNullable = true, Order = 1)]
        public List<NameType> ProcessingEventGroupName { get; set; }
