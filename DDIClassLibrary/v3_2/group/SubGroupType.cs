...
namespace DDIClassLibrary.v3_2.group
{
    ...
    public class SubGroupType : VersionableType, IHaveDefaultValues
    {
        public SubGroupType()
        {
        ...
        [System.Xml.Serialization.XmlElement(Namespace = "ddi:conceptualcomponent:3_2", IsNullable = true, Order = 15)]
        ...
        [System.Xml.Serialization.XmlElement(Namespace = "ddi:datacollection:3_2", IsNullable = true, Order = 17)]
        ...
        [System.Xml.Serialization.XmlElement("LogicalProduct", typeof(DDIClassLibrary.v3_2.logicalproduct.LogicalProductType), Namespace = "ddi:logicalproduct:3_2", IsNullable = true, Order = 19)]
        ...
        [System.Xml.Serialization.XmlElement(Namespace = "ddi:physicaldataproduct:3_2", IsNullable = true, Order = 21)]
        ...
        [System.Xml.Serialization.XmlElement(Namespace = "ddi:physicalinstance:3_2", IsNullable = true, Order = 23)]
        ...
        [System.Xml.Serialization.XmlElement(Namespace = "ddi:archive:3_2", IsNullable = true, Order = 25)]
        ...
        [System.Xml.Serialization.XmlElement(Namespace = "ddi:ddiprofile:3_2", IsNullable = true, Order = 27)]
        ...
        [System.Xml.Serialization.XmlElement(Namespace = "ddi:comparison:3_2", IsNullable = true, Order = 29)]
        ...
        [System.Xml.Serialization.XmlElement(Namespace = "ddi:studyunit:3_2", IsNullable = true, Order = 31)]
        ...
        [System.Xml.Serialization.XmlElement(IsNullable = true, Order = 33)]
        public List<SubGroupType> SubGroup { get; set; }

        [System.Xml.Serialization.XmlElement(IsNullable = true, Order = 34)]
