...
namespace DDIClassLibrary.v3_2.conceptualcomponent
{
    ...
    public class GeographicStructureGroupType : VersionableType, IHaveDefaultValues
    {
        public GeographicStructureGroupType()
        {
            this.GeographicStructureGroupName = new List<NameType>();
        ...
        public CodeValueType TypeOfGeographicStructureGroup { get; set; }
        
        [System.Xml.Serialization.XmlElement(IsNullable = true, Order = 1)]
        public List<NameType> GeographicStructureGroupName { get; set; }
