...
namespace DDIClassLibrary.v3_2.conceptualcomponent
{
    ...
    public class UniverseGroupType : VersionableType, IHaveDefaultValues
    {
        public UniverseGroupType()
        {
            this.UniverseGroupName = new List<NameType>();
        ...
        public List<NameType> UniverseGroupName { get; set; }
